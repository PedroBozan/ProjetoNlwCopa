...
import appLogoImage from '../assets/logo.svg'
...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        <Image src={appLogoImage} alt="NLW Copa" />
      ...
      <Image src={appPreviewImage} alt="Dois celulares exibindo uma prévia da aplicação do NLW Copa" quality={100} />
